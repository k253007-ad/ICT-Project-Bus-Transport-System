let stops = ["2K Stop", "Chota Gate", "Digh Road", "Malir Cant", "Malir Halt", "Model Colony", "Shah Faisal Town"];
...
allLi.forEach(element => {
    ...
    element.onclick = () => { 
        ...
        window.location.assign(`/Latest/stops.html?stop=${encodeURIComponent(stopName)}`);
    }
});
